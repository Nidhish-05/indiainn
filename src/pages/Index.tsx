...
export default function Index() {
  ...
  // Cursor glow follower — rAF + lerp for ultra-smooth tracking
  const cursorRef = useRef<HTMLDivElement>(null);
  useEffect(() => {
    let mouseX = 0, mouseY = 0;
    let curX = 0, curY = 0;
    let rafId = 0;
    const LERP = 0.25; // higher = snappier, lower = smoother trail
    ...
    const tick = () => {
      ...
      if (cursorRef.current) {
        cursorRef.current.style.transform = `translate3d(${curX - 10}px, ${curY - 10}px, 0)`;
      }
  ...
  return (
    <div className="min-h-screen relative text-foreground selection:bg-primary/30 selection:text-white pb-[72px]">
      ...
      <div className="relative z-10 w-full">
        ...
        {/* ═══ THE CRISIS ═══ */}
        <section id="problem" className="py-14 px-4 sm:px-6 max-w-7xl mx-auto">
          <ScrollReveal>
          ...
          <ScrollReveal delay={400}>
            <blockquote className="mt-12 p-8 rounded-[2rem] glass-panel text-center max-w-4xl mx-auto relative overflow-hidden">
        ...
        <section className="py-14 px-4 sm:px-6 max-w-7xl mx-auto">
          <ScrollReveal>
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-heading font-bold mt-4 tracking-tight gradient-text">Ward-Level AQI Map</h2>
            <p className="text-lg text-secondary-foreground/80 mt-3 max-w-2xl font-light">Interactive real-time pollution monitoring across 20 Delhi wards. Click any ward to inspect AQI levels and pollution sources.</p>
          </ScrollReveal>
          <ScrollReveal delay={200}>
            <div className="mt-10 neon-card rounded-[2.5rem] p-2 sm:p-4 pulse-glow overflow-hidden">
              <InteractiveAQIMap />
            </div>
          </ScrollReveal>
        </section>
        ...
        {/* ═══ THE SOLUTION ═══ */}
        <section id="solution" className="py-14 px-4 sm:px-6 max-w-7xl mx-auto">
          <ScrollReveal>
            <SectionHeader label="THE SOLUTION" />
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-heading font-bold mt-4 tracking-tight gradient-text">Three Layers of Intelligence</h2>
          </ScrollReveal>
          ...
          <ScrollReveal delay={500}>
            <div className="mt-16">
              <div className="text-center max-w-3xl mx-auto mb-10 glass-panel p-8 rounded-[2rem]">
        ...
        <section className="py-16 px-4 sm:px-6 relative">
          <div className="max-w-7xl mx-auto relative z-10">
            <ScrollReveal>
              ...
              <h2 className="text-5xl sm:text-6xl md:text-7xl font-heading font-bold mt-4 tracking-tight gradient-text">
                Governance-as-Code
              </h2>
              <p className="text-xl md:text-2xl text-secondary-foreground mt-4 max-w-3xl font-light">
            ...
            <ScrollReveal delay={400}>
              <div className="mt-10 glass-panel p-6 sm:p-10 rounded-[2.5rem]">
                <GovernancePipeline />
              </div>
            </ScrollReveal>
        ...
        <section className="py-14 px-4 sm:px-6 max-w-7xl mx-auto">
          <ScrollReveal>
            ...
            <h2 className="text-4xl sm:text-5xl font-heading font-bold mt-4 tracking-tight gradient-text">Metrics & Transparency</h2>
          </ScrollReveal>

          <ScrollReveal delay={200}>
            <div className="mt-10 glass-panel p-8 rounded-[2rem] pulse-glow">
              <ImpactCounters />
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={600}>
            <div className="mt-12 glass-panel p-8 rounded-[2rem]">
        ...
        {/* ═══ ARCHITECTURE ═══ */}
        <section id="architecture" className="py-14 px-4 sm:px-6 max-w-7xl mx-auto">
          <ScrollReveal>
            <SectionHeader label="ARCHITECTURE" />
            <h2 className="text-4xl sm:text-5xl font-heading font-bold mt-4 tracking-tight gradient-text">Component Blueprint</h2>
          </ScrollReveal>
        ...
        {/* ═══ THE EDGE ═══ */}
        <section id="intelligence" className="py-14 px-4 sm:px-6 max-w-7xl mx-auto">
          <ScrollReveal>
            <SectionHeader label="THE EDGE" />
            <h2 className="text-4xl sm:text-5xl font-heading font-bold mt-4 tracking-tight gradient-text">Deep Context Models</h2>
          </ScrollReveal>
        ...
        {/* ═══ SCALABILITY ═══ */}
        <section id="scale" className="py-14 px-4 sm:px-6 max-w-7xl mx-auto">
          <ScrollReveal>
            <SectionHeader label="SCALABILITY" />
            <h2 className="text-4xl sm:text-5xl font-heading font-bold mt-4 tracking-tight gradient-text">Expansion Roadmap</h2>
          </ScrollReveal>

          <ScrollReveal delay={200}>
            <div className="mt-10 glass-panel p-2 sm:p-10 rounded-[3rem]">
              <IndiaPhaseMap />
            </div>
          </ScrollReveal>
        ...
        {/* ═══ RESEARCH ═══ */}
        <section id="research" className="py-14 px-4 sm:px-6 max-w-7xl mx-auto">
          <ScrollReveal>
            <SectionHeader label="RESEARCH FOUNDATION" />
            <h2 className="text-4xl sm:text-5xl font-heading font-bold mt-4 tracking-tight gradient-text">Peer-Reviewed Engine</h2>
          </ScrollReveal>
        ...
        {/* ═══ FOOTER ═══ */}
        <footer className="py-14 px-4 sm:px-6 pb-16">
          <ScrollReveal>
            <div className="glass-panel max-w-4xl mx-auto p-10 rounded-[3rem] text-center relative overflow-hidden">
      ...
      {/* Fixed Live Ticker at bottom of viewport */}
